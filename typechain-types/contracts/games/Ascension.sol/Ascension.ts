...
export declare namespace Ascension {
  export type AscensionPlayerInfoStruct = {
  ...
  export type AscensionPlayerInfoStructOutput = [
...
export interface Ascension extends BaseContract {
  ...
  getPlayerInfo: TypedContractMethod<
    [gameId: BigNumberish],
    [Ascension.AscensionPlayerInfoStructOutput[]],
    "view"
  >;
