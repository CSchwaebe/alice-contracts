...
export declare namespace Threes {
  export type ThreesPlayerInfoStruct = {
  ...
  export type ThreesPlayerInfoStructOutput = [
...
export interface ThreesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "commitChoice"
      | "endExpiredGames"
...
export interface Threes extends BaseContract {
  connect(runner?: ContractRunner | null): Threes;
  waitForDeployment(): Promise<this>;

  interface: ThreesInterface;
  ...
  commitChoice: TypedContractMethod<
  ...
  getPlayerInfo: TypedContractMethod<
    [gameId: BigNumberish],
    [Threes.ThreesPlayerInfoStructOutput[]],
    "view"
  >;
  ...
  revealChoice: TypedContractMethod<
    [choice: BigNumberish, salt: BytesLike],
    [void],
    "nonpayable"
  >;
