...
export interface RagnarokGameMasterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_PLAYERS"
      | "activePlayers"
...
export interface RagnarokGameMaster extends BaseContract {
  connect(runner?: ContractRunner | null): RagnarokGameMaster;
  waitForDeployment(): Promise<this>;

  interface: RagnarokGameMasterInterface;
