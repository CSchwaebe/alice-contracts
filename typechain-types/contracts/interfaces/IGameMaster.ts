...
export interface IGameMasterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activeGameCount"
      | "activeGames"
...
export interface IGameMaster extends BaseContract {
  connect(runner?: ContractRunner | null): IGameMaster;
  waitForDeployment(): Promise<this>;

  interface: IGameMasterInterface;
