...
export declare namespace IDoors {
...
export interface IDoorsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "endExpiredGames"
      | "endGame"
...
export interface IDoors extends BaseContract {
  connect(runner?: ContractRunner | null): IDoors;
  waitForDeployment(): Promise<this>;

  interface: IDoorsInterface;
